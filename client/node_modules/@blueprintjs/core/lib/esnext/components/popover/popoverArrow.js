...
export const PopoverArrow = ({ arrowProps: { ref, style }, placement }) => (React.createElement("div", { className: Classes.POPOVER_ARROW, ref: ref, style: style.left == null || isNaN(+style.left) ? {} : style },
