...
function htmlElement(tagName, tagClassName) {
    ...
    return function (props) {
        var className = props.className, elementRef = props.elementRef, children = props.children, htmlProps = tslib_1.__rest(props, ["className", "elementRef", "children"]);
        return React.createElement(tagName, tslib_1.__assign(tslib_1.__assign({}, htmlProps), { className: (0, classnames_1.default)(tagClassName, className), ref: elementRef }), children);
    };
}
